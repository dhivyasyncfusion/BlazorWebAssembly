(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["sf-barcode"],{
    ...
    exportAsImage: function exportAsImage(exportType, fileName, element, isReturnBase64) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, this.imageExport(exportType, fileName, element, isReturnBase64)];
            case 1:
              returnValue = _a.sent();
...
}]);(async()=>{await import(`${document.baseURI}_content/Syncfusion.Blazor/scripts/syncfusion-blazor-base.min.js?v=19.3.1`).then(()=>{sfBlazor.loadDependencies('sfbarcodegenerator');})})();