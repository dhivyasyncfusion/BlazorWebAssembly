(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["spinner"],{
...
var sfspinner = function sfspinner(exports) {
  ...
  function createCircle(start, end, easing, duration, count, max, spinnerInfo) {
    ...
    function updatePath(value, container) {
      if (!sf.base.isNullOrUndefined(container.querySelector('svg.e-spin-material')) || !sf.base.isNullOrUndefined(container.querySelector('svg.e-spin-material3'))) {
        var svg = void 0;
        ...
        } else if (!sf.base.isNullOrUndefined(container.querySelector('svg.e-spin-material3')) && !sf.base.isNullOrUndefined(container.querySelector('svg.e-spin-material3').querySelector('path.e-path-circle'))) {
  ...
  function ensureTemplate(template, container, theme, cssClass, makeEle) {
    if (sf.base.isNullOrUndefined(template) && !container.classList.contains(CLS_SPINTEMPLATE)) {
      ...
      if (!sf.base.isNullOrUndefined(spinTemplate)) {
