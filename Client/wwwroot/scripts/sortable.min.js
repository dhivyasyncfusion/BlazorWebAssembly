  ...
  var Sortable = /** @class */function (_super) {
    ...
    function Sortable(element, options) {
      ...
      _this.onDrag = function (e) {
        ...
        } else if (_this.curTarget !== _this.target && _this.scope && _this.curTarget !== target && !sf.base.isNullOrUndefined(newInst.placeHolder)) {
          sf.base.remove(_this.getSortableInstance(_this.curTarget).placeHolderElement);
          _this.curTarget = _this.target;
        }
      ...
      _this.onDragStop = function (e) {
        ...
        sf.base.getComponent(_this.element, 'draggable').intDestroy(e.event);
      };
      _this.bind();
      return _this;
    }
    ...
    Sortable.prototype.keyDownHandler = function (e) {
      if (e.keyCode === 27) {
        var dragStop = sf.base.getComponent(this.element, 'draggable');
        if (dragStop) {
