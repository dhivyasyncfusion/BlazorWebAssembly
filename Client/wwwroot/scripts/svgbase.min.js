...
window.sf.svgbase = function (exports) {
  ...
  var TooltipBorder = /** @class */function (_super) {
    ...
    __decorate([sf.base.Property('')], TooltipBorder.prototype, "dashArray", void 0);
  ...
  var Tooltip = /** @class */function (_super) {
    ...
    Tooltip.prototype.createTooltipElement = function () {
      ...
      if (!this.template || this.shared) {
        ...
        var pathElement = this.renderer.drawPath({
          ...
          'stroke-width': (this.theme === 'Fabric' || this.theme === 'Fluent') && !this.border.width ? 1 : this.border.width,
    ...
    Tooltip.prototype.renderTooltipElement = function (areaBounds, location) {
      ...
      var x = 0;
      var y = 0;
      if (!sf.base.isNullOrUndefined(groupElement)) {
        if (this.header !== '') {
        ...
        if (this.header !== '') {
          ...
          var pathElement_1 = this.renderer.drawPath({
            ...
            'stroke-width': 1,
            'fill': null,
            'opacity': this.theme === ('Material3' || false) ? 0.2 : 0.8,
        ...
        for (var i = 0, len = textCollection.length; i < len; i++) {
          ...
          for (var j = 0, len_1 = lines.length; j < len_1; j++) {
            ...
            if (!isColumn && line === ' ' || line.replace(/<b>/g, '').replace(/<\/b>/g, '').trim() !== '') {
              ...
              var textFont = sf.base.extend({}, this.textStyle, null, true)[key];
        ...
        if (this.controlName === 'Chart') {
          ...
          if (!withInAreaBounds(location.x, location.y, bounds) || this.outOfBounds) {
            ...
            if (location.x + this.arrowPadding + width > boundsX + bounds.width || this.isNegative) {
              location.x = (symbolLocation.x > bounds.width ? bounds.width : symbolLocation.x) + clipX - markerHeight - (this.arrowPadding + width);
            }
    ...
    Tooltip.prototype.animateTooltipDiv = function (tooltipDiv, rect) {
      ...
      new sf.base.Animation({}).animate(tooltipDiv, {
        duration: this.duration === 0 && sf.base.animationMode === 'Enable' ? 300 : this.duration,
        progress: function progress(args) {
          currenDiff = args.timeStamp / args.duration;
          tooltipDiv.style.animation = null;
          if (_this.controlName === 'Chart' && _this.shared && !_this.enableRTL) {
            tooltipDiv.style.transition = sf.base.isBlazor() ? 'transform 0.3s' : 'transform 0.1s';
    ...
    __decorate([sf.base.Property(false)], Tooltip.prototype, "crosshair", void 0);
    __decorate([sf.base.Property(false)], Tooltip.prototype, "enableShadow", void 0);
    ...
    __decorate([sf.base.Property(4)], Tooltip.prototype, "rx", void 0);
    __decorate([sf.base.Property(4)], Tooltip.prototype, "ry", void 0);
    ...
    __decorate([sf.base.Property(7)], Tooltip.prototype, "arrowPadding", void 0);
    ...
    __decorate([sf.base.Property(false)], Tooltip.prototype, "isFixed", void 0);
    ...
    __decorate([sf.base.Property('')], Tooltip.prototype, "controlName", void 0);
    ...
    __decorate([sf.base.Property(false)], Tooltip.prototype, "allowHighlight", void 0);
