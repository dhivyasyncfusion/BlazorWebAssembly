(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["sf-toolbar"],{
...
window.sfBlazor.Toolbar = function () {
  ...
  var SfToolbar = /** @class */function () {
    ...
    SfToolbar.prototype.eleContains = function (el) {
      ...
      return el.classList.contains(CLS_SEPARATOR) || el.classList.contains(CLS_DISABLE) || el.getAttribute('disabled') || el.classList.contains(CLS_HIDDEN) || !sf.base.isVisible(el) || isInputEle;
    };
        ...
        if (elWidth < width || destroy) {
          ...
          if (this_1.options.overflowMode !== 'Extended') {
            eleSplice.slice(0, index).forEach(function (el) {
              if (!sf.base.isNullOrUndefined(el.classList) && (el.classList.contains(CLS_TBAROVERFLOW) || el.classList.contains(CLS_SEPARATOR))) {
                if (el.classList.contains(CLS_SEPARATOR)) {
                  el.style.display = '';
...
}]);(async()=>{await import(`${document.baseURI}_content/Syncfusion.Blazor/scripts/syncfusion-blazor-base.min.js?v=19.3.1`).then(()=>{sfBlazor.loadDependencies('sftoolbar');})})();