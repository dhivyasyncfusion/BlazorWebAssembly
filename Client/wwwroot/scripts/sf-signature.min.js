(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["sf-signature"],{
...
window.sfBlazor.Signature = function () {
  ...
  var SignatureBase = /** @class */function (_super) {
    __extends$1(SignatureBase, _super);
    ...
    SignatureBase.prototype.initialize = function (element, dotnetRef) {
      ...
      if (sf.base.isNullOrUndefined(this.signatureValue)) {
    ...
    SignatureBase.prototype.wireEvents = function () {
      if (sf.base.isNullOrUndefined(this.pointColl) && !this.isReadOnly && !this.disabled) {
        sf.base.EventHandler.add(this.canvasContext.canvas, 'mousedown touchstart', this.mouseDownHandler, this);
        sf.base.EventHandler.add(this.canvasContext.canvas, 'keydown', this.keyboardHandler, this);
        ...
        sf.base.EventHandler.add(document, 'mouseup', this.mouseUpHandler, this);
      }
    };
    SignatureBase.prototype.unwireEvents = function (type) {
      if (type === 'mouseup' || type === 'touchend') {
        ...
        sf.base.EventHandler.remove(this.canvasContext.canvas, 'keydown', this.keyboardHandler);
    ...
    SignatureBase.prototype.draw = function (text, fontFamily, fontSize, x, y) {
      ...
      if (sf.base.isNullOrUndefined(x) && sf.base.isNullOrUndefined(y)) {
        ...
        startX = sf.base.isNullOrUndefined(x) ? startX : x;
        startY = sf.base.isNullOrUndefined(y) ? startY + fontSize / 2 : y + fontSize / 2;
      }
    ...
    SignatureBase.prototype.destroy = function () {
      if (this.getModuleName() !== 'image-editor') {
        ...
        sf.base.removeClass([this.element], 'e-' + this.getModuleName());
  ...
  var SfSignature = /** @class */function () {
    function SfSignature(dataId, element, parameter, dotnetRef) {
      this.dataId = dataId;
      this.element = element;
      window.sfBlazor.setCompInstance(this);
      this.dotnetRef = dotnetRef;
      this.signatureBase = new SfSignatureBase();
      this.signatureBase.backgroundColor = parameter.backgroundColor;
      this.signatureBase.backgroundImage = parameter.backgroundImage;
      this.signatureBase.strokeColor = parameter.strokeColor || "#000000";
      this.signatureBase.isReadOnly = parameter.isReadOnly;
      this.signatureBase.disabled = parameter.disabled;
      this.signatureBase.saveWithBackground = parameter.saveWithBackground;
      this.signatureBase.signatureValue = parameter.signatureValue;
      this.signatureBase.minStrokeWidth = parameter.minStrokeWidth || 0.5;
      this.signatureBase.maxStrokeWidth = parameter.maxStrokeWidth || 2;
      this.signatureBase.velocity = parameter.velocity || 0.7;
    }
  ...
  var SfSignatureBase = /** @class */function (_super) {
    __extends(SfSignatureBase, _super);
    function SfSignatureBase() {
      return _super !== null && _super.apply(this, arguments) || this;
    }
    SfSignatureBase.prototype.onPropertyChanged = function () {};
    SfSignatureBase.prototype.preRender = function () {};
    SfSignatureBase.prototype.render = function () {};
    return SfSignatureBase;
  }(SignatureBase);
  var Signature = {
    initialize: function initialize(dataId, element, parameter, dotnetRef) {
      if (!sf.base.isNullOrUndefined(element)) {
        new SfSignature(dataId, element, parameter, dotnetRef);
        var instance = window.sfBlazor.getCompInstance(dataId);
        instance.signatureBase.initialize(element, dotnetRef);
      }
    },
    clear: function clear(dataId) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      instance.signatureBase.clear();
    },
    undo: function undo(dataId) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      instance.signatureBase.undo();
    },
    redo: function redo(dataId) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      instance.signatureBase.redo();
    },
    save: function save(dataId, fileType, fileName) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      switch (fileType) {
        case 0:
          instance.signatureBase.save("Png", fileName);
          break;
        case 1:
          instance.signatureBase.save("Jpeg", fileName);
          break;
        case 2:
          instance.signatureBase.save("Svg", fileName);
          break;
      }
    },
    draw: function draw(dataId, text, fontFamily, fontSize, x, y) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      instance.signatureBase.draw(text, fontFamily, fontSize, x, y);
    },
    load: function load(dataId, signature, width, height) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      instance.signatureBase.load(signature, width, height);
    },
    getSignature: function getSignature(dataId, type) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      switch (type) {
        case 0:
          return instance.signatureBase.getSignature("Png");
        case 1:
          return instance.signatureBase.getSignature("Jpeg");
        case 2:
          return instance.signatureBase.getSignature("Svg");
      }
      return null;
    },
    saveAsBlob: function saveAsBlob(dataId, element) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      return instance.saveAsBlob(element);
    },
    onPropertyChanged: function onPropertyChanged(dataId, key, value) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      instance.signatureBase.propertyChanged(key, value);
    },
    isEmpty: function isEmpty(dataId) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      return instance.signatureBase.isEmpty();
    },
    canUndo: function canUndo(dataId) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      return instance.signatureBase.canUndo();
    },
    canRedo: function canRedo(dataId) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      return instance.signatureBase.canRedo();
    },
    destroy: function destroy(dataId) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      instance.signatureBase.destroy();
    },
    refresh: function refresh(dataId) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      instance.signatureBase.refresh();
    }
  };
  return Signature;
}();
...
}]);(async()=>{await import(`${document.baseURI}_content/Syncfusion.Blazor/scripts/syncfusion-blazor-base.min.js?v=19.3.1`).then(()=>{sfBlazor.loadDependencies('sfsignature');})})();